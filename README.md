...
- Implemented spatial autocorrelation analyses using [manual Global Moran's I](extra_figures/modeling_data/global_moran_plots/manual_global_moran.ipynb), [Global Moran's I and correlogram analyses](extra_figures/modeling_data/global_moran_plots/global_moran_correlograms.ipynb), and [spatial correlograms](extra_figures/modeling_data/global_moran_plots/correlograms_notebook_final.ipynb) to evaluate spatial dependence and inform model selection.

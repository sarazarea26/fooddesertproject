...
- Conducted exploratory spatial analyses, including manual [Moran's I calculations](extra_figures/modeling_data/global_moran_plots/manual_global_moran.ipynb), [Global Moran's I analyses](extra_figures/modeling_data/global_moran_plots/global_moran.ipynb), and [spatial correlograms across all five counties](extra_figures/modeling_data/global_moran_plots/correlograms_notebook_final.ipynb), to assess spatial autocorrelation and guide model selection.

...
- Constructed population density and urban farm maps for Harris County to examine potential geographic patterns in food access and resource distribution ([code](extra_figures/population_urban_farm_map/combined_mapping.ipynb); [final map](extra_figures/population_urban_farm_map/harris_urban_farms_population_density.png)).

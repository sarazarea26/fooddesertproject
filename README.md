...
- Created [binary maps](extra_figures/binary_maps) to visualize geographic overlap between urban farm access and socioeconomic, health, and food-access indicators.
...
- Implemented [Moran's I calculations and spatial correlograms](final_figures/Figure_4/all_counties_mapping.ipynb) to evaluate spatial autocorrelation and inform spatial model selection.

...
- Implemented spatial autocorrelation analyses using [manual Global Moran's I](extra_figures/modeling_data/manual_global_moran.ipynb), [Global Moran's I](extra_figures/modeling_data/global_moran.ipynb), [five-county analyses](extra_figures/modeling_data/all_counties_mapping.ipynb), and [spatial correlograms](extra_figures/modeling_data/correlograms_notebook_final.ipynb) to evaluate spatial dependence and inform model selection.
